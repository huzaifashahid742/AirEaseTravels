...
//       if (!path.includes('UniversityAdmin') && !path.includes('StudentAdmin')) {
...
const Admin_Navbar = () => {
  ...
  const navItems = [
    ...
    },
    {
      ...
      label: 'Comparison',
      show: hasPermission(user, 'universities'), // Protected by university or custom permission
    },
    {
      to: '/admin/team',
      icon: 'fa-users-gear',
